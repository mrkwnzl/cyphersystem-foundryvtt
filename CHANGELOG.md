...
## [3.5.2] - 2026-05-24
### Fixed
- Fixed the combat tab not updating properly.

## [3.5.1] - 2026-05-10
### Fixed
- Added missing secret setting macro to change the cost of the first LOE to 2 pool points.
- Fixed bug that prevented creating new items directly on the character sheet.

### Removed
- Removed the ability to select the editor on the sheet as TinyMCE is no longer supported.
...
### Fixed
- Fixed missing setting for the additional sentence field.

## [3.4.1] - 2025-10-04
### Changed
- Updated translations for German and Portuguese.
